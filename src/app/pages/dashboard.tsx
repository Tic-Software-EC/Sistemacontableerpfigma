...
export function Dashboard() {
  ...
  return (
    <div className="space-y-6">
      {/* Header */}
      <div>
        <h1 className="text-3xl font-black text-secondary dark:text-white tracking-tight">Dashboard</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {stats.map((stat, index) => (
          ...
          >
            ...
            <p className="text-sm font-light text-gray-500 dark:text-gray-400 mb-1">{stat.label}</p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-700 p-6">
          <h2 className="text-lg font-bold text-secondary dark:text-white mb-4">Actividad Reciente</h2>
            ...
            {[
              ...
              <div key={index} className="flex items-start gap-3 pb-4 border-b border-gray-100 dark:border-gray-700 last:border-0">
                ...
                <div className="flex-1">
                  <p className="text-sm font-normal text-secondary dark:text-gray-200">{activity.action}</p>
        ...
        {/* Gráfico de Ventas */}
        <div className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-700 p-6">
          <h2 className="text-lg font-bold text-secondary dark:text-white mb-4">Ventas del Mes</h2>
      ...
      {/* Accesos Rápidos */}
      <div className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-700 p-6">
        <h2 className="text-lg font-bold text-secondary dark:text-white mb-4">Accesos Rápidos</h2>
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {[
            ...
            <button
              key={index}
              className="flex flex-col items-center gap-3 p-4 rounded-lg border-2 border-dashed border-gray-200 dark:border-gray-700 hover:border-primary hover:bg-primary/5 dark:hover:bg-primary/10 transition-all group"
            >
              <item.icon className="w-8 h-8 text-gray-400 dark:text-gray-500 group-hover:text-primary transition-colors" />
              <span className="text-sm font-normal text-gray-600 dark:text-gray-300 group-hover:text-secondary dark:group-hover:text-white">
                {item.label}
              </span>
            </button>
          ))}
