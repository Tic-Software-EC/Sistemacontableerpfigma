...
export function SalesConfigContent() {
  ...
  const IN     = `w-full px-3 py-2 border rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-primary/40 focus:border-primary transition-all ${isLight ? "bg-white border-gray-300 text-gray-900" : "bg-[#1a2936] border-white/10 text-white"}`;
  const OB     = isLight ? "" : "bg-[#0D1B2A]";
  const rowBg  = isLight ? "bg-gray-50 hover:bg-gray-100" : "bg-[#1a2936]/50 hover:bg-[#1a2936]";
