    ...
    <div className="space-y-8 max-w-6xl">
      ...
      <div>
        ...
        <p className="text-gray-400 text-sm">
          Configura los servicios de envío de emails, SMS, WhatsApp y preferencias de notificaciones
        </p>
      </div>
          ...
          <div className="bg-white/5 border border-white/10 rounded-2xl p-6">
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center gap-2">
                ...
                <h3 className="text-white font-bold text-xl">Servidor SMTP (Email)</h3>
              </div>
          ...
          <div className="bg-white/5 border border-white/10 rounded-2xl p-6">
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center gap-2">
                ...
                <h3 className="text-white font-bold text-xl">Configuración de SMS</h3>
              </div>
              <div className="flex items-center gap-3">
          ...
          <div className="bg-white/5 border border-white/10 rounded-2xl p-6">
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center gap-2">
                ...
                <h3 className="text-white font-bold text-xl">Configuración de WhatsApp</h3>
              </div>
              <div className="flex items-center gap-3">
                <label className="flex items-center gap-2 cursor-pointer">
                  <span className="text-gray-300 text-sm">Habilitado</span>
            ...
            <div className="bg-white/5 border border-white/10 rounded-2xl p-6">
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center gap-2">
                  ...
                  <h3 className="text-white font-bold text-xl">Preferencias de Notificaciones</h3>
                </div>
                <button
