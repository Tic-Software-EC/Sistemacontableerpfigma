...
import {
  ...
  AlertCircle, X, FileText, Eye, Edit, Trash2,
  Calendar, DollarSign, Package, Truck, PackageCheck, XCircle,
  Send, Check,
} from "lucide-react";
      ...
      <div className="flex flex-col gap-4">
        ...
        <div className={`rounded-lg p-4 border ${
          ...
          <div className="flex items-start gap-3">
            {activeTab === "draft" && <FileText className={`w-4 h-4 flex-shrink-0 mt-0.5 ${isLight ? "text-gray-600" : "text-gray-300"}`} />}
            {activeTab === "pending" && <Clock className={`w-4 h-4 flex-shrink-0 mt-0.5 ${isLight ? "text-yellow-600" : "text-yellow-300"}`} />}
            {activeTab === "approved" && <CheckCircle className={`w-4 h-4 flex-shrink-0 mt-0.5 ${isLight ? "text-blue-600" : "text-blue-300"}`} />}
            {activeTab === "partial" && <Package className={`w-4 h-4 flex-shrink-0 mt-0.5 ${isLight ? "text-purple-600" : "text-purple-300"}`} />}
            {activeTab === "received" && <PackageCheck className={`w-4 h-4 flex-shrink-0 mt-0.5 ${isLight ? "text-green-600" : "text-green-300"}`} />}
            {activeTab === "cancelled" && <XCircle className={`w-4 h-4 flex-shrink-0 mt-0.5 ${isLight ? "text-red-600" : "text-red-300"}`} />}
            <div>
              <p className={`text-sm font-semibold ${
                ...
                {activeTab === "partial" && "Órdenes Parcialmente Recibidas"}
                {activeTab === "received" && "Órdenes Completamente Recibidas"}
              ...
              <p className={`text-xs mt-0.5 ${
                ...
                {activeTab === "draft" && "Estas órdenes aún no han sido enviadas al proveedor. Puedes editarlas o eliminarlas."}
                {activeTab === "pending" && "Estas órdenes han sido enviadas y están esperando aprobación del jefe de compras."}
                {activeTab === "approved" && "Estas órdenes han sido aprobadas y están listas para recibir mercancía."}
                {activeTab === "partial" && "Estas órdenes tienen recepciones parciales de mercancía. Falta completar la recepción."}
                {activeTab === "received" && "Estas órdenes han sido completamente recibidas y el proceso está finalizado."}
        ...
        <div className="flex items-center justify-between gap-3">
          {/* Buscador */}
          <div className={`flex-1 max-w-md flex items-center gap-2 border rounded-lg px-3 py-1.5 ${
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="flex items-center gap-2 px-3 py-1.5 rounded-lg text-sm font-medium text-white bg-primary hover:opacity-90 transition-opacity"
            >
        ...
        <div className={`rounded-lg border overflow-hidden ${isLight ? "border-gray-200" : "border-white/10"}`}>
          <div className="overflow-x-auto">
            <table className="w-full">
              <thead className={isLight ? "bg-darkBg" : "bg-white/5"}>
                <tr>
                  <th className="text-left px-4 py-3 text-xs font-bold text-gray-400 uppercase tracking-wider w-12">
                    <input
                      type="checkbox"
                  ...
                  <th className="text-left px-4 py-3 text-xs font-bold text-gray-400 uppercase tracking-wider">Número</th>
                  <th className="text-left px-4 py-3 text-xs font-bold text-gray-400 uppercase tracking-wider">Fecha</th>
                  <th className="text-left px-4 py-3 text-xs font-bold text-gray-400 uppercase tracking-wider">Proveedor</th>
                  <th className="text-left px-4 py-3 text-xs font-bold text-gray-400 uppercase tracking-wider">RUC</th>
                  <th className="text-left px-4 py-3 text-xs font-bold text-gray-400 uppercase tracking-wider">Entrega</th>
                  <th className="text-right px-4 py-3 text-xs font-bold text-gray-400 uppercase tracking-wider">Total</th>
                  <th className="text-right px-4 py-3 text-xs font-bold text-gray-400 uppercase tracking-wider w-32">Acciones</th>
                </tr>
              </thead>
                ...
                {filteredOrders.length === 0 ? (
                  ...
                  filteredOrders.map((order) => (
                    ...
                    >
                      ...
                      <td className="px-4 py-3">
                        <span className="text-sm">{new Date(order.date).toLocaleDateString("es-EC")}</span>
                      </td>
                      <td className="px-4 py-3">
                        <span className="text-sm font-medium">{order.supplier.name}</span>
                      </td>
                      <td className="px-4 py-3">
                        <span className="text-sm font-mono">{order.supplier.ruc}</span>
                      </td>
                      <td className="px-4 py-3">
                        <span className="text-sm">{new Date(order.deliveryDate).toLocaleDateString("es-EC")}</span>
                      </td>
                        ...
                        <div className="flex items-center justify-end gap-1">
                          <button
                            ...
                            className={`p-1.5 rounded transition-colors ${
                              isLight ? "hover:bg-gray-200 text-gray-600" : "hover:bg-white/10 text-gray-300"
                            }`}
                            title="Ver detalles"
                          >
                          ...
                          {activeTab === "pending" && (
                            <button
                              ...
                              className="p-1.5 rounded transition-colors hover:bg-green-500/10 text-green-500"
                              title="Aprobar"
                            >
                          ...
                          {(activeTab === "approved" || activeTab === "partial") && (
                            <button
                              ...
                              className="p-1.5 rounded transition-colors hover:bg-purple-500/10 text-purple-500"
